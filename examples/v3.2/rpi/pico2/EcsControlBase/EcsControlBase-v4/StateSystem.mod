...
**)
  ...
  IMPORT C := Components, Texts, TextIO, Messages, TextMessages, BUFstr, QueueingPort, SIOgpio;

  CONST
    ExtString = " print some more to extend beyond FIFO depth (v4: queueing port)";
