@echo off
rem Build script for Secure6: RP2350 S/NS, dual image, no partition table.
...
rem Secure
set S_INI=sec\v31-rp2350-pico2-secure-s.ini
set S_MOD=sec\S.mod
set S_MAP=sec\S.map
set S_BIN=sec\S.bin
set S_ADDR=10000100
...
rem Non-secure
set NS_INI=nonsec\v31-rp2350-pico2-secure-ns.ini
set NS_MOD=nonsec\NS.mod
set NS_BIN=nonsec\NS.bin
set NS_ADDR=10080000
