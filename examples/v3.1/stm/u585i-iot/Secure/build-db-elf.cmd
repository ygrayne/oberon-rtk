@echo off
rem Build script for Secure: STM32U585 (U585I-IOT) S/NS, dual image.
...
rem Secure
set S_INI=sec\v31-stm32u585-iot-secure-s.ini
set S_MOD=sec\S.mod
set S_MAP=sec\S.map
set S_BIN=sec\S.bin
set S_RDB=sec\rdb
...
rem Non-secure
set NS_INI=nonsec\v31-stm32u585-iot-secure-ns.ini
...
python -m make-elf %S_BIN%:%S_ADDR% %NSC_BIN%:%NSC_ADDR% --rdb-dir %S_RDB% %DEBUG% --sym-prefix %S_SYM% || exit /b
