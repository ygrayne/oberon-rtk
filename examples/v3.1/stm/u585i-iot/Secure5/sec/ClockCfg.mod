...
(**
  ...
  --
  Program Secure5
  Program-specific clocks configuration.
  --
  MCU: STM32U585AI
...
**)
  ...
  BEGIN
    ...
    CLK.ConfigBusPresc(prescCfg);

    CLK.StartPLL(CLK.PLL1);
    CLK.ConfigSysClk(CLK.SysClk_PLL)
  END Init;
