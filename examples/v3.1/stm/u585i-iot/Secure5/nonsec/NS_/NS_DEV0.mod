...
CONST
  ...
  RCC_SEC_HSI*    = 0;
  RCC_SEC_ALL* = {0 .. 12};
  GTZC1_BASE* = NS_MCU.GTZC1_BASE;
  GTZC2_BASE* = NS_MCU.GTZC2_BASE;
  GTZC1_TZSC*   = GTZC1_BASE;
  GTZC1_TZIC*   = GTZC1_BASE + 00400H;
  GTZC1_MPCBB1* = GTZC1_BASE + 00800H;
  GTZC1_MPCBB2* = GTZC1_BASE + 00C00H;
  GTZC1_MPCBB3* = GTZC1_BASE + 01000H;
  GTZC2_TZSC*   = GTZC2_BASE;
  GTZC2_TZIC*   = GTZC2_BASE + 00400H;
  GTZC2_MPCBB4* = GTZC2_BASE + 00800H;
  TZSC_CR_Offset*         = 000H;
  ...
  FLASH_SECBB1R*      = FLASH_BASE + 080H;
  FLASH_SECBB2R*      = FLASH_BASE + 0A0H;
  FLASH_SECHDPCR*     = FLASH_BASE + 0C0H;
  FLASH_PRIVCFGR*     = FLASH_BASE + 0C4H;
  FLASH_PRIVBB1R*     = FLASH_BASE + 0D0H;
  FLASH_PRIVBB2R*     = FLASH_BASE + 0F0H;
  RAMCFG_BASE* = NS_MCU.RAMCFG_BASE;
  RAMCFG_Offset* = 040H;
