...
**)
  ...
  IMPORT
    SYSTEM, Main, EXC, Kernel, Out, Errors, TIMERS_DEV;

  CONST
    RunPrio = EXC.ExcPrio4;
    RunIntNo = EXC.IRQ_SW_0;
    SysTickPrio = EXC.ExcPrio2;
    TIMER_RAWL = TIMERS_DEV.TIMER0_BASE + TIMERS_DEV.TIMER_TIMERAWL_Offset;
