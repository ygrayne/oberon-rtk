...
**)
  ...
  BEGIN
    ...
    Terminals.Open(UART0, UART0_TxPinNo, UART0_RxPinNo, Baudrate0, UARTkstr.PutString, UARTkstr.GetString);
    Terminals.Open(UART1, UART1_TxPinNo, UART1_RxPinNo, Baudrate1, UARTkstr.PutString, UARTkstr.GetString);
