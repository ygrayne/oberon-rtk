...
**)
  ...
  CONST
    ...
    RunIntHighNo = MCU.PPB_SPAREIRQ_IRQ3;
    RunPrioLow = MCU.PPB_ExcPrio4;
    RunPrioHigh = MCU.PPB_ExcPrio1;
...
BEGIN
  ...
  GPIO.OutputEnable({Pin1, Pin2, Pin3, Pin4, TrigPin});
  GPIO.Clear({Pin1, Pin2, Pin3, Pin4, TrigPin});
  run
END K4print.
