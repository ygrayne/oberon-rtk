...
**)
  ...
  IMPORT
    ...
    StartUp, RuntimeErrorsOut, Terminals, Out, In, GPIO, UARTdev, UARTstr, UARTstrKbw, UARTstrKint, MCU := MCU2, FPUctrl;
  ...
  CONST
    ...
    UARTrdyQintNo = MCU.PPB_SPAREIRQ_IRQ0;
    UARTintPrio = MCU.PPB_ExcPrio7;
