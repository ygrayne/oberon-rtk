...
**)
  ...
  CONST
    ...
    TIM12_BASE*       = 040001800H + PERI_S_Offset;
    TIM13_BASE*       = 040001C00H + PERI_S_Offset;
    TIM14_BASE*       = 040002000H + PERI_S_Offset;
    WWDG_BASE*        = 040002C00H + PERI_S_Offset;
    IWDG_BASE*        = 040003000H + PERI_S_Offset;
    SPI2_BASE*        = 040003800H + PERI_S_Offset;
    SPI3_BASE*        = 040003C00H + PERI_S_Offset;
    ...
    I3C1_BASE*        = 040005C00H + PERI_S_Offset;
    CRS_BASE*         = 040006000H + PERI_S_Offset;
    USART6_BASE*      = 040006400H + PERI_S_Offset;
    USART10_BASE*     = 040006800H + PERI_S_Offset;
    USART11_BASE*     = 040006C00H + PERI_S_Offset;
    HDMI_CEC_BASE*    = 040007000H + PERI_S_Offset;
    UART7_BASE*       = 040007800H + PERI_S_Offset;
    UART8_BASE*       = 040007C00H + PERI_S_Offset;
    UART9_BASE*       = 040008000H + PERI_S_Offset;
    UART12_BASE*      = 040008400H + PERI_S_Offset;
    DTS_BASE*         = 040008C00H + PERI_S_Offset;
    LPTIM2_BASE*      = 040009400H + PERI_S_Offset;
    FDCAN1_BASE*      = 04000A400H + PERI_S_Offset;
    FDCAN2_BASE*      = 04000A800H + PERI_S_Offset;
    FDCAN_RAM*        = 04000AC00H + PERI_S_Offset;
    ...
    SPI4_BASE*        = 040014C00H + PERI_S_Offset;
    SPI6_BASE*        = 040015000H + PERI_S_Offset;
    SAI1_BASE*        = 040015400H + PERI_S_Offset;
    SAI2_BASE*        = 040015800H + PERI_S_Offset;
    USB_FS_BASE*      = 040016000H + PERI_S_Offset;
    USB_FS_RAM*       = 040016400H + PERI_S_Offset;

    (* AHB1 *)
    GPDMA1_BASE*      = 040020000H + PERI_S_Offset;
    GPDMA2_BASE*      = 040021000H + PERI_S_Offset;
    FLASH_BASE*       = 040022000H + PERI_S_Offset;
    CRC_BASE*         = 040023000H + PERI_S_Offset;
    CORDIC_BASE*      = 040023800H + PERI_S_Offset;
    FMAC_BASE*        = 040023C00H + PERI_S_Offset;
    RAMCFG_BASE*      = 040026000H + PERI_S_Offset;
    ETH_MAC_BASE*     = 040028000H + PERI_S_Offset;
    ICACHE_BASE*      = 040030400H + PERI_S_Offset;
    DCACHE_BASE*      = 040031400H + PERI_S_Offset;
    ...
    DAC1_BASE*        = 042028400H + PERI_S_Offset;
    ...
    (* APB3 *)
    SBS_BASE*         = 044000400H + PERI_S_Offset;
    SPI5_BASE*        = 044002000H + PERI_S_Offset;
    LPUART1_BASE*     = 044002400H + PERI_S_Offset;
    I2C3_BASE*        = 044002800H + PERI_S_Offset;
    I2C4_BASE*        = 044002C00H + PERI_S_Offset;
    LPTIM1_BASE*      = 044004400H + PERI_S_Offset;
    LPTIM3_BASE*      = 044004800H + PERI_S_Offset;
    LPTIM4_BASE*      = 044004C00H + PERI_S_Offset;
    LPTIM5_BASE*      = 044005000H + PERI_S_Offset;
    LPTIM6_BASE*      = 044005400H + PERI_S_Offset;
    VREFBUF_BASE*     = 044007400H + PERI_S_Offset;
    RTC_BASE*         = 044007800H + PERI_S_Offset;
    TAMP_BASE*        = 044007C00H + PERI_S_Offset;

    (* AHB3 *)
    PWR_BASE*         = 044020800H + PERI_S_Offset;
    RCC_BASE*         = 044020C00H + PERI_S_Offset;
    EXTI_BASE*        = 044022000H + PERI_S_Offset;
    DEBUG_BASE*       = 044024000H + PERI_S_Offset;

    (* AHB4 *)
    OTFDEC1_BASE*     = 046005000H + PERI_S_Offset;
    SDMMC1_BASE*      = 046008000H + PERI_S_Offset;
    DLYBSD1_BASE*     = 046008400H + PERI_S_Offset;
    DLYBSD2_BASE*     = 046008800H + PERI_S_Offset;
    SDMMC2_BASE*      = 046008C00H + PERI_S_Offset;
    DLYBOS1_BASE*     = 04600F000H + PERI_S_Offset;
    FMC_BASE*         = 047000400H + PERI_S_Offset;
    OCTOSPI1_BASE*    = 047001400H + PERI_S_Offset;
