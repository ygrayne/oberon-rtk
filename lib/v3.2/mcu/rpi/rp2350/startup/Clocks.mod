...
**)
  ...
  BEGIN
    ...
    clkCfg.refDivInt := 4; (* max clk_ref = 25 MHz *)
    ...
    ticksCfg.sysTickDiv0 := 12;
    ticksCfg.sysTickDiv1 := 12;
    ticksCfg.timerDiv0 := 12;
    ticksCfg.timerDiv1 := 12;
    ticksCfg.watchdogDiv := 12;
