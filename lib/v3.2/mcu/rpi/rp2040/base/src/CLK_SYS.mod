...
(**
  ...
  datasheet 2.18.4, p233 PLL
  datasheet 2.16.7, p219 XOSC
  datasheet 2.17.8, p223 ROSC
  --
  MCU: RP2040
  --
...
**)
  ...
  IMPORT BASE, RESETS_SYS, WATCHDOG_DEV;
  ...
  CONST
    ...
    (* ticks *)
    CLK_WATCHDOG_TICK* = WATCHDOG_DEV.WATCHDOG_TICK;
