...
**)
  ...
  BEGIN
    ...
    ExtMem[Core0].start := BASE.SRAM4_BASE;
    ExtMem[Core0].end := BASE.SRAM4_BASE + BASE.SRAM4_Size;
    ...
    DataMem[Core1].end := BASE.SRAM0_BASE + BASE.SRAM0_Size; (* top of 256k *)
    ...
    ExtMem[Core1].start := BASE.SRAM5_BASE;
    ExtMem[Core1].end := BASE.SRAM5_BASE + BASE.SRAM5_Size;
